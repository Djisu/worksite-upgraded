...
export const SERVICE_REVIEW_CREATE_FAIL = 'SERVICE_REVIEW_CREATE_FAIL'
export const SERVICE_REVIEW_CREATE_RESET = 'SERVICE_REVIEW_CREATE_RESET'

export const SERVICE_ENTRY_REQUEST = 'SERVICE_ENTRY_REQUEST'
export const SERVICE_ENTRY_SUCCESS = 'SERVICE_ENTRY_SUCCESS'
export const SERVICE_ENTRY_FAIL = 'SERVICE_ENTRY_FAIL'
export const SERVICE_ENTRY_RESET = 'SERVICE_ENTRY_RESET'
